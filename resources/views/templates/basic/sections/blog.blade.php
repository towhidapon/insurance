...
<section class="blog py-60">
    ...
    <div class="container">
                    ...
                    <div class="blog-item">
                        <div class="blog-item__thumb">
                            <a href="{{ route('blog.details', $blogElement->slug) }}" class="blog-item__thumb-link">
                                <img class="image1" src="{{ frontendImage('blog', 'thumb_' . @$blogElement->data_values->image, '310x270') }}" alt="img1">
                                <img class="image2" src="{{ frontendImage('blog', 'thumb_' . @$blogElement->data_values->image, '310x270') }}" alt="img2">
                            </a>
                        </div>
        ...
        <div class="blog__bottom">
            <a href="{{ route('blogs') }}" class="btn--base btn"> @lang('View All')</a>
        </div>
    </div>
</section>
